...
@section('content')
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-primary mb-2">Add New Project</h1>
        <p class="text-secondary">Create a new portfolio project</p>
    </div>

    <form action="{{ route('admin.portfolio.portfolios.store') }}" method="POST" enctype="multipart/form-data" class="max-w-4xl">
        @csrf
        ...
        <div class="bg-surface border border-border rounded-xl p-6 mb-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" required class="w-full px-4 py-3 rounded-lg border border-border bg-background text-primary focus:outline-none focus:ring-2 focus:ring-primary/20">
                </div>

                <!-- Description -->
                <div>
                    <label for="description" class="block text-sm font-medium text-primary mb-2">Description *</label>
                    <textarea id="description" name="description" rows="6" required class="w-full px-4 py-3 rounded-lg border border-border bg-background text-primary focus:outline-none focus:ring-2 focus:ring-primary/20"></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="client_name" name="client_name" class="w-full px-4 py-3 rounded-lg border border-border bg-background text-primary focus:outline-none focus:ring-2 focus:ring-primary/20">
                    </div>

                    <div>
                        <label for="client_company" class="block text-sm font-medium text-primary mb-2">Client Company</label>
                        <input type="text" id="client_company" name="client_company" class="w-full px-4 py-3 rounded-lg border border-border bg-background text-primary focus:outline-none focus:ring-2 focus:ring-primary/20">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-secondary">Recommended: 1200x800px</p>
                    </div>

                    <div>
                        <label for="project_url" class="block text-sm font-medium text-primary mb-2">Project URL</label>
                        <input type="url" id="project_url" name="project_url" placeholder="https://" class="w-full px-4 py-3 rounded-lg border border-border bg-background text-primary focus:outline-none focus:ring-2 focus:ring-primary/20">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" id="project_date" name="project_date" class="w-full px-4 py-3 rounded-lg border border-border bg-background text-primary focus:outline-none focus:ring-2 focus:ring-primary/20">
                    </div>

                    <div class="flex items-center gap-3 pt-8">
                        <input type="checkbox" id="is_featured" name="is_featured" value="1" class="w-4 h-4 rounded border-border bg-background text-primary focus:ring-2 focus:ring-primary/20">
